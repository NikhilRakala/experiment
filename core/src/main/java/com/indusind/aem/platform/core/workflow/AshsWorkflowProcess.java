...
@Component(
        ...
        immediate = true,
        property = {
                "process.label" + " = Ash Workflow Process",
                Constants.SERVICE_VENDOR + "=AEM Geeks",
                Constants.SERVICE_DESCRIPTION + " = Custom ash workflow step."
        }
)
public class AshsWorkflowProcess implements WorkflowProcess {

    private static final Logger log = LoggerFactory.getLogger(AshsWorkflowProcess.class);
    ...
    public void execute(WorkItem workItem, WorkflowSession workflowSession, MetaDataMap processArguments) {
        ...
        try {
            ...
            log.info("Your Error in AshWorkflowProcess------>",e);
        }
    }
}