...
@Component(
        ...
        property = {
                "process.label" + " = Ash Workflow Step",
                Constants.SERVICE_VENDOR + "=AEM Geeks",
                Constants.SERVICE_DESCRIPTION + " = Custom ash workflow step."
        }
)
public class AshWorkflowStep implements WorkflowProcess {
    private static final Logger LOG = LoggerFactory.getLogger(AshWorkflowStep.class);
    ...
    public void execute(WorkItem workItem, WorkflowSession workflowSession, MetaDataMap processArguments) {
        ...
        try {
            ...
            if (workflowData.getPayloadType().equals("JCR_PATH")) {
                ...
                LOG.info("\n Custom Workflow Step ERROR {} ",e.getMessage());
        }
    }
}