...
import com.indusind.aem.platform.core.config.GeeksCAConfig;
...
public class CAConfigImpl implements CAConfig {
    ...
    protected static final String RESOURCE_TYPE = "/apps/Indusind/components/card";
    ...
    GeeksCAConfig caConfig=getContextAwareConfig(currentPage.getPath(),resourceResolver);
        ...
        LOG.info("siteCountry"+siteCountry);
